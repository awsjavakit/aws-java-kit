...
public class EventParser<I> {
   ...
   * AwsEventBridgeEvent where the detail object in of type
   * {@literal ClassA<ClassB<ClassC<...ClassZ>>..>}.
   *
  ...
  private JavaType createGenericClassContainingAllPreviousTypes(JavaType mostRecentType,
    Class<?> currentClass) {
