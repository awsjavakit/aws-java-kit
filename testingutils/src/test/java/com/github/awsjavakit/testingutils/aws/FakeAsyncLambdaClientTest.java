...
class FakeAsyncLambdaClientTest {

  public static final ObjectMapper JSON = new ObjectMapper();

  @Test
  void shouldInvokeSubmittedFunction() throws ExecutionException, InterruptedException {
    var client = new FakeAsyncLambdaClient<>(FakeAsyncLambdaClientTest::someFunction, SampleInput.class,
      JSON);
    ...
    var response = client.invoke(invokeRequest).get().payload().asUtf8String();
  ...
  @Test
  void shouldReturnNumberOfInvocations() throws ExecutionException, InterruptedException {
    var client = new FakeAsyncLambdaClient<>(FakeAsyncLambdaClientTest::someFunction, SampleInput.class,
      JSON);
    var input = new SampleInput(randomString());
    var invokeRequest = InvokeRequest.builder()
    ...
    for (var rep = 0; rep < repetitions; rep++) {
      client.invoke(invokeRequest).get();
    }
