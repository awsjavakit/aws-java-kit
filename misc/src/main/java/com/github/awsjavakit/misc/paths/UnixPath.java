 ...
 * that we do not have to deal all the time with the path delimiters.
 */
public final class UnixPath {
  ...
  private static Stream<String> splitInputElementsContainingPathDelimiter(
    Stream<String> pathElements) {
    return pathElements
