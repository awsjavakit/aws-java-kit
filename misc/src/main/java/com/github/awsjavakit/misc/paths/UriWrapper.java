...
public class UriWrapper {
  ...
  private static URI createUriFromHostUri(String scheme, String host, int port)
  ...
  private static URI createUriFromHostDomain(String scheme, String host, int port)
    throws URISyntaxException {
