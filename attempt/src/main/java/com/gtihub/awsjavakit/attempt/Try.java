...
public abstract class Try<T> {
   ...
   * @return a new {@link Try} instance
   */
  public static <T, R, E extends Exception> Function<T, Try<R>> attempt(
  ...
  public abstract <S, E extends Exception> Try<S> flatMap(
    FunctionWithException<T, Try<S>, E> action);
  ...
  public abstract <E extends Exception> T orElse(FunctionWithException<Failure<T>, T, E> action)
    throws E;

  public abstract <E extends Exception> Optional<T> toOptional(
    ConsumerWithException<Failure<T>, E> action) throws E;
